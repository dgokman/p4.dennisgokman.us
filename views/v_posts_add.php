...
<form method='POST' action='/posts/p_add'>
    ...
    <input name='number1' id='number1' size='63'></textarea>
    <br><br>
    
    <label for='adj3'>Adjective:</label><br>
    <input name='adj3' id='adj3' size='63'></textarea>
    <br><br>
    
    <label for='adverb2'>Adverb:</label><br>
    <input name='adverb2' id='adverb2' size='63'></textarea>
    <br><br>
    
    <label for='name2'>Name of Person in Room:</label><br>
    <input name='name2' id='name2' size='63'></textarea>
    <br><br>
    
    <label for='adj4'>Adjective:</label><br>
    <input name='adj4' id='adj4' size='63'></textarea>
    <br><br>
    
    <label for='noun1'>Noun:</label><br>
    <input name='noun1' id='noun1' size='63'></textarea>
    <br><br>
    
    <label for='name3'>Name of Person in Room:</label><br>
    <input name='name3' id='name3' size='63'></textarea>
    <br><br>
    
    
    <label for='noun2'>Noun:</label><br>
    <input name='noun2' id='noun2' size='63'></textarea>
    <br><br>
    
    <label for='brand'>Brand:</label><br>
    <input name='brand' id='brand' size='63'></textarea>
    <br><br>
    
    <label for='liquid'>Liquid:</label><br>
    <input name='liquid' id='liquid' size='63'></textarea>
    <br><br>
    
    <label for='adj5'>Adjective:</label><br>
    <input name='adj5' id='adj5' size='63'></textarea>
    <br><br>
    
    <label for='adj6'>Adjective:</label><br>
    <input name='adj6' id='adj6' size='63'></textarea>
    <br><br>
